...
import (
	...
	"github.com/DesignersAxis/gofpdf"
	"github.com/DesignersAxis/gofpdf/internal/example"
	"github.com/DesignersAxis/gofpdf/internal/files"
)
...
func ExampleFpdf_CellFormat_align() {
	...
	var formatRect = func(pdf *gofpdf.Fpdf, recList []recType) {
		...
		for pageJ := 0; pageJ < 2; pageJ++ {
			...
			linkStr = "https://github.com/DesignersAxis/gofpdf"
		}
	}
	pdf := gofpdf.New("P", "mm", "A4", "") // A4 210.0 x 297.0
...
func ExampleFpdf_RegisterImageReader() {
	...
	const (
		...
		ht       = 297
		fontSize = 15
		urlStr   = "https://github.com/DesignersAxis/gofpdf/blob/master/image/gofpdf.png?raw=true"
